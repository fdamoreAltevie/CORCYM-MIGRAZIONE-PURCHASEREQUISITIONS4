		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#purchaserequisitionapprovalS4HANA-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"purchaserequisitionapprovalS4HANA-display": {
								"semanticObject": "purchaserequisitionapprovalS4HANA",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=purchaserequisitionapprovalS4HANA",
									"url": sap.ui.require.toUrl("purchaserequisitionapprovalS4HANA")
								}
							}
						}
					}
